...
#define SCREEN_HEIGHT 256						// Chiều dài cửa sổ
...
#define NUMBER_MAP_LEVEL 3						// Số level
#define TILE_SIZE 16							
...
#define player Player::GetInstance()			// player instance
...
#define PLAYER_WIDTH 20							// Chiều dài player
#define PLAYER_STANDING_HEIGHT 26				// Chiều cao player khi đứng
#define PLAYER_SITTING_HEIGHT 18				// Chiều cao player khi nằm
#define PLAYER_HEALTH 16
#define PLAYER_LIVES 3							// Số mạng của player

// ===== Các thông số cho WEAPON SWORD ====
#define WEAPON_SWORD_WIDTH 32					// Chiều dài vũ khí
#define WEAPON_SWORD_HEIGHT 18					// Chiều cao vũ khí
